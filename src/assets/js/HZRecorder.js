// (function (window) {
  ...
          this.upload = function (callback) {
              // console.log(2,speechUrl)
  //             var fd = new FormData();
  //             fd.append('binary',this.blobToFile(this.getBlob(), 'audio'),'audio.wav');
  ...
          }
          ...
          this.convertBase64UrlToBytes= function(base64Str) {
